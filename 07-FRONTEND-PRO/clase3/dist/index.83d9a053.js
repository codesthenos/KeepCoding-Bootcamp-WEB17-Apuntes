...
function startCountdown() {
    ...
    let today = new Date(), dd = String(today.getDate()).padStart(2, "0"), mm = String(today.getMonth() + 1).padStart(2, "0"), yyyy = today.getFullYear(), nextYear = yyyy + 1, dayMonth = "11/11/", birthday = dayMonth + yyyy;
    today = mm + "/" + dd + "/" + yyyy;
...
//# sourceMappingURL=index.83d9a053.js.map
